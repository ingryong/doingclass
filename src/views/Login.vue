  ...
  <div class=login>
    ...
    <div class="login_group">
      <div class="input_group f-column m-auto">
        <input type="text" class="form-control" placeholder="이메일" ref="user_id" v-model="user_id" v-on:keyup.enter="login">
        <input type="password" class="form-control" placeholder="비밀번호" ref="user_pw" v-model="user_pw" v-on:keyup.enter="login">
      </div>
      <div class="btn_group">
